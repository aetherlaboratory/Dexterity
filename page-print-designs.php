...
<a class="image-link" data-bs-toggle="modal" data-bs-target="#print-modal<?php echo $counter; ?>" href="#"><img class="w-75 rounded-2 mx-auto" src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'full');?>" /></a>
